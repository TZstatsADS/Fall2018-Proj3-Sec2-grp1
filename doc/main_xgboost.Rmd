...
if(run.cv){
  ...
  parasname<-c("nrounds", "depth")
  for ( para in parasname){
  plot(model_values[,para], err_cv[,1], xlab="Interaction Depth", ylab="CV Error",
       main="Cross Validation Error", type="n", ylim=c(0, 0.25))
  points(model_values[,para], err_cv[,1], col="blue", pch=16)
  lines(model_values[,para], err_cv[,1], col="blue")
  arrows(model_values[,para], err_cv[,1]-err_cv[,2], model_values[,para], err_cv[,1]+err_cv[,2], 
